        ...
        return new Promise(function(resolve, reject) {
            ...
            navigator.mediaDevices.getUserMedia(cameraSettings).then(function(stream) {
                ...
                if (getPrompt()) {
                    ...
                    prompt.style.backgroundColor = backgroundColor
                    prompt.style.padding = "3px 5px"
                ...
                shutterButton.onclick = function() {
                    ...
                    if (!Object.values(images).includes(null)) {
                        ...
                        flipAnimation.style.backgroundColor = buttonColor
                        flipAnimation.style.transform = "rotateY(0deg)"

                        flipAnimationContainer.appendChild(flipAnimation)
                        container.appendChild(flipAnimationContainer)
                        setTimeout(function() {
